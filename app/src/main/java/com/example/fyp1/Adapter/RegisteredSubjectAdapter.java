...
public class RegisteredSubjectAdapter extends ArrayAdapter<Subject> {
    ...
    public RegisteredSubjectAdapter(Context context, int resource, ArrayList<Subject> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView subjectCodeName = (TextView) convertView.findViewById(R.id.registered_subject_list_code);
        TextView subjectCreditHours = (TextView) convertView.findViewById(R.id.registered_subject_list_credit_hours);
